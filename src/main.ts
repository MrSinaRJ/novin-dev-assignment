...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Novin Dev Assignment Job Offer API')
    .setDescription(
      'A Simple chat system without authentication and authorization.',
    )
    .setVersion('0.0.1')
    .addGlobalParameters({
      in: 'header',
    ...
    .addServer(`https://novin-dev-assignment.darkube.app`, 'Test Server')
